...
for (let i=1; i <= 100; i++){
    if (i % 3 === 0 && i % 5 === 0) {
        console.log("FizzBuzz"); // fizzbuzz prints
    }
    else if (i % 3 === 0) {
        console.log("Fizz"); // prints fizz if divisitble by 3
    }
    else if (i % 5 === 0) {
        console.log("Buzz"); // prints buzz if divisible by 5
    }
    else {
        console.log(i); // prints the number if none of the conditions above are met
    }
}